      ...
      setPackages([
        {
          ...
          description: 'A comprehensive 3-day package covering Yala & Udawalawe with 5-star glamping accommodation.',
          duration: '3 Days / 2 Nights',
          price: 45000,
          destinations: ['Yala', 'Udawalawe'],
          category: 'Luxury',
          includes: ['Glamping Stay', 'All Meals', 'VIP Jeep', 'Private Guide'],
          highlights: ['Sunset Champagne', 'Private Leopard Tracking'],
        },
        {
          _id: '2',
          name: 'Family Adventure',
          image: 'https://images.unsplash.com/photo-1589656966895-2f33e7653819?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'Perfect for families. Kid-friendly guides, safe interactions, and comfortable family suites.',
          duration: '2 Days / 1 Night',
          price: 30000,
          destinations: ['Udawalawe'],
          category: 'Family',
          includes: ['Family Suite', 'Kids Meals', 'Safe Transport'],
          highlights: ['Elephant Transit Home', 'Baby Elephants'],
        },
        {
          _id: '3',
          name: 'Budget Explorer',
          image: 'https://images.unsplash.com/photo-1534177616072-ef7dc12044f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'Experience the wild without breaking the bank. Group joining tours with standard amenities.',
          duration: '1 Day',
          price: 12000,
          destinations: ['Yala'],
          category: 'Budget',
          includes: ['Park Entry', 'Standard Jeep', 'Lunch'],
          highlights: ['Full Day Safari', 'Wildlife Spotting'],
        },
        {
          _id: '4',
          name: 'Photography Masterclass',
          image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'Designed for photographers. Golden hour access, bean bags, and expert positioning.',
          duration: '2 Days / 1 Night',
          price: 35000,
          destinations: ['Yala', 'Bundala'],
          category: 'Photography',
          includes: ['Modified Jeep', 'Permits', 'Photography Guide'],
          highlights: ['Leopards', 'Bird Photography', 'Golden Hour'],
        },
      ]);
    } finally {
      setLoading(false);
