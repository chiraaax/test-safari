      ...
      setRentals([
        {
          ...
          vehicleType: 'SUV',
          image: 'https://images.unsplash.com/photo-1594246830723-5e92c2196627?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'The King of the Safari. Unmatched off-road capability combined with premium comfort for up to 7 passengers.',
          pricePerDay: 12000,
          capacity: 7,
          features: ['4WD', 'AC', 'GPS', 'Cool Box'],
          available: true,
          fuel: 'Diesel',
        },
        {
          ...
          vehicleType: 'SUV',
          image: 'https://images.unsplash.com/photo-1620021673898-1e43c510825f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'A robust and reliable choice for family trips. Features excellent ground clearance and a spacious interior.',
          pricePerDay: 10000,
          capacity: 7,
          features: ['4WD', 'AC', 'Comfort Seats'],
          available: true,
          fuel: 'Diesel',
        },
        {
          ...
          description: 'Perfect for larger groups. High-roof comfort with adjustable seats and ample luggage space for extended tours.',
          pricePerDay: 15000,
          capacity: 12,
          features: ['Dual AC', 'Reclining Seats', 'Tinted Glass'],
          available: true,
          fuel: 'Diesel',
        },
        {
          _id: '4',
          vehicleName: 'Safari Defender (Open)',
          vehicleType: 'Jeep',
          image: 'https://images.unsplash.com/photo-1533090161767-e6ffed986c88?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          description: 'The ultimate photography platform. Custom modified open-top Land Rover Defender for 360-degree wildlife viewing.',
          pricePerDay: 8000,
          capacity: 6,
          features: ['Open Top', '4WD', 'Roll Cage', 'Bean Bags'],
          available: true,
          fuel: 'Diesel',
        },
        {
          ...
          description: 'Experience the wild in absolute luxury. Premium leather interiors, advanced suspension, and climate control.',
          pricePerDay: 25000,
          capacity: 5,
          features: ['Panoramic Roof', 'Leather', 'Premium Sound'],
          available: true,
          fuel: 'Petrol',
        },
      ]);
